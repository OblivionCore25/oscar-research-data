...
\author{
    \IEEEauthorblockN{Fabian Gonzalez}
    \IEEEauthorblockA{
    ...
    \and
    \IEEEauthorblockN{Collaborator Name}
    \IEEEauthorblockA{
        \textit{Department of Computer Science}\\
        \textit{University}\\
...
\smallskip\noindent\textbf{Data Availability.} The study corpus definition, analysis scripts, exported datasets, and the automated patch mining pipeline are available at \url{https://github.com/OblivionCore25}.
