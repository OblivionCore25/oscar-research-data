...
\author{
    \IEEEauthorblockN{R. Fabian Gonzalez-Arellano}
    \IEEEauthorblockA{
    ...
    \and
    \IEEEauthorblockN{Rakesh Podder}
    \IEEEauthorblockA{
...
This section describes the architecture of \textsc{Oscar}\footnote{Open Supply-Chain Assurance \& Resilience. Source code available at: \url{https://github.com/OblivionCore25}}, a multi-tier platform that implements the cross-level risk model defined in §\ref{sec:approach}.
...
\smallskip\noindent\textbf{Data Availability.} The study corpus definition, analysis scripts, exported datasets, and the automated patch mining pipeline are available at \url{https://github.com/OblivionCore25/oscar-research-data}.
